...
void Averages(int iblk) //Print results for current block
{
   ...
   const int wd=12;
    ...
    stima_pot = blk_av[iv]/blk_norm/(double)npart + vtail; //Potential energy //vtail posso metterlo anche nel walker e poi dividere per blk_norm
